...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[90%] md:w-max rounded-full px-6 md:pr-3 py-2 border-[0.5px] border-primary/30 bg-surface/10 backdrop-blur-xl z-[150] flex justify-between items-center md:gap-12 lg:gap-20 shadow-[0_0_20px_rgba(255,77,0,0.15)] transition-all duration-300">
        ...
        <div className="flex items-center gap-4 z-10">
          <a href="https://calendly.com/punitvachhani/30min" target="_blank" rel="noopener noreferrer" className="hidden md:block bg-primary-fixed text-on-primary-fixed px-6 py-2 rounded-full font-label-mono text-[10px] tracking-widest hover:shadow-[0_0_25px_rgba(255,77,0,0.4)] transition-all active:scale-95 duration-200">LET'S TALK</a>
...
const HeroSection = ({ mousePosition }) => (
  <header className="relative min-h-[884px] md:min-h-screen flex flex-col items-center justify-center text-center px-grid-margin overflow-hidden" id="hero-section">
    ...
    <div
      ...
      style={{
        background: `radial-gradient(circle 600px at ${mousePosition.x}px ${mousePosition.y}px, rgba(255,77,0,0.15), transparent 80%)`,
    ...
    >
      <div className="inline-flex items-center gap-3 border-[0.5px] border-primary/40 px-5 py-2 rounded-full mb-8 bg-primary/5 backdrop-blur-sm">
        <span className="w-2 h-2 bg-primary rounded-full animate-pulse-glow shadow-[0_0_8px_rgba(255,77,0,0.8)]"></span>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
        <button className="bg-primary-fixed text-on-primary-fixed font-label-mono text-label-mono px-10 py-4 rounded-full flex items-center gap-2 hover:shadow-[0_0_30px_rgba(255,77,0,0.5)] transition-all transform hover:-translate-y-1">
...
const AboutSection = () => (
  <section className="py-section-gap px-grid-margin max-w-7xl mx-auto" id="about">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
      ...
      >
        <div
          className="aspect-square rounded-2xl border border-primary/30 overflow-hidden relative shadow-[0_0_40px_rgba(255,77,0,0.15)]"
          style={{ background: 'radial-gradient(circle at top left, rgba(255,77,0,0.3), transparent 75%), #0a0a0a' }}
        >
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-4 pt-8 mt-auto">
          <a href="#" className="inline-flex items-center justify-center bg-primary-fixed text-on-primary-fixed font-label-mono text-[10px] font-bold uppercase tracking-widest px-6 py-3.5 rounded-full hover:shadow-[0_0_20px_rgba(255,77,0,0.6)] transition-all shadow-[0_0_15px_rgba(255,77,0,0.3)]">
...
const CtaSection = () => (
  <section className="py-section-gap relative overflow-hidden bg-[#0a0a0a]">
    <div className="px-grid-margin max-w-5xl mx-auto flex flex-col items-center text-center relative z-10">
      ...
      >
        <a href="https://calendly.com/punitvachhani/30min" target="_blank" rel="noopener noreferrer" className="bg-primary-fixed text-on-primary-fixed font-label-mono text-label-mono px-12 py-5 rounded-full flex items-center justify-center gap-2 hover:shadow-[0_0_40px_rgba(255,77,0,0.6)] transition-all transform hover:-translate-y-1">
          LET'S TALK ↗
        </a>
